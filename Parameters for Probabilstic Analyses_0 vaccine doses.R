...
##############################################
        ...
        ## By provinvce ## 
##############################################
COVID_cases_BC = 310513
COVID_cases_BC_SE = 26383

COVID_cases_AB = 355546
COVID_cases_AB_SE = 27561

COVID_cases_SK = 69898
COVID_cases_SK_SE = 6503

COVID_cases_MB = 62524
COVID_cases_MB_SE = 6303

COVID_cases_ON = 941067
COVID_cases_ON_SE = 65425

COVID_cases_QC = 536288
COVID_cases_QC_SE = 33513

COVID_cases_ATL = 99670
COVID_cases_ATL_SE = 7080

###################################################
## Proportion that reported PCC-related symptoms ##
###################################################
prevalence_PCC = 0.248
prevalence_PCC_SE = 0.016

###################################################
    ## Emergency department rate per case ##
###################################################
pro_ED_L_bound = c(0.022, 0.032, 0.043, 0.065)  
pro_ED_L_mode = c(0.029, 0.043, 0.058, 0.087)  
pro_ED_U_mode = c(0.043, 0.065, 0.087, 0.13)
pro_ED_U_bound = c(0.05, 0.076, 0.101, 0.151)

###################################################
    ## Inpatient hospitalization rate per case ##
###################################################
pro_Inpatient_L_bound = c(0.005, 0.008, 0.011, 0.016)
pro_Inpatient_L_mode = c(0.007, 0.011, 0.014, 0.021) 
pro_Inpatient_U_mode = c(0.011, 0.016, 0.021, 0.032)  
pro_Inpatient_U_bound = c(0.012, 0.019, 0.025, 0.037)
...
###################################################
pro_left_work_fu = 400
pro_left_work_fu_SE = 21
